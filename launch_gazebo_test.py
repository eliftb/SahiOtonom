...
NODE_LAUNCH_ORDER = [
    ...
    },
    {
        ...
        "ros_args": [
            ...
            'traffic_red_lost_release_delay:=5.0',
            ...
            'bus_stop_wait_duration:=10.0',
            'bus_stop_entry_duration:=1.2',
            'bus_stop_align_duration:=24.0',
            'bus_stop_exit_duration:=1.8',
            'bus_stop_exit_align_duration:=2.4',
            'bus_stop_speed:=0.22',
            'bus_stop_steering_angle:=0.18',
            'bus_stop_align_gain_multiplier:=1.05',
            'bus_stop_align_steering_limit:=0.16',
            ...
            'bus_stop_pose_x:=-15.633688',
            'bus_stop_pose_y:=52.691515',
